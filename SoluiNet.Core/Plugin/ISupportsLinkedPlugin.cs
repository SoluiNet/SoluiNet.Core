// <copyright file="ISupportsLinkedPlugin.cs" company="SoluiNet">
...
namespace SoluiNet.Core.Plugin
{
    ...
    /// <summary>
    /// Provides an interface which shows that this plugin supports linked plugins.
    /// </summary>
    ...
    public interface ISupportsLinkedPlugin
    {
    }
}
